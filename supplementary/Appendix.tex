...
\caption{\label{fig:Figure-C4}Relationship between party ID and exposure to posts from Russian Internet Research Agency (IRA) accounts. Predicted values with 95\% prediction intervals are shown}
\end{figure}
